		...
		<table width="80%" align="center" border="2" bordercolor="#339999">
			<tr>
				<td align="Center">
					<div id="header">
						&nbsp;
						<div align="center"><b>Festival Event Registration System</b></div>
					</div> <!-- header end --> <br />
					<table>
						<tr>
							<!--content begin -->
						...
						<tr><div class="error" value="${isRegistered}"></div></tr>
						<tr><div class="error" value="${message}"></div></tr>
						<tr>
							<td><div align="right">User Name</div></td>
							<td><input type="text" path="userName" name="userName" size=22/></td>
							<td><div align="left"><form:errors path="userName" cssClass="error" /></div></td>
						</tr>
						<tr>
							<td><div align="right">Password</div></td>
							<td><input type="password" path="passWord" name="passWord" size=23/></td>
							<td><div align="left"><form:errors path="passWord" cssClass="error" /></div></td>
							
						</tr>
						<tr>
							<td colspan="2" align="right"><input type='submit' value=" Login "></input> <br /></td>
						</tr>
						<tr>
							<td></td>
						</tr>
						...
						<tr>
							<td>
								...
								<div id="content"><a href="registration.html">Register here</a>
								</div>
							</td>
						</tr>
					</table> <br />
