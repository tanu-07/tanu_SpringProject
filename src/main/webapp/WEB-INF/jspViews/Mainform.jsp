		...
		<tr>
			<td>
				<div id="header" align="center">
					&nbsp;
					<b>Festival Registration System</b>
				</div>
						...
						<td width="1000">
							<table cellpadding="5" width="100%">
									...
									<td>
										<div align="center" id="content">
											<h3>
												...
												<jstlcore:out value="${visitor.firstName}"></jstlcore:out></span> to your
												portal page.....
											</h3>
										</div>
									<tr><div class="error" value="${message}" id="m"></div></tr>
								...
								<div id="content" align="center">
									...
									<tr align="center"><div class="error" value="${messageEvent}"></div></tr>
										...
										<tr>
											<td colspan="9" align="center"
												style="font-weight: bold; color: red;">	<tr><div class="error" value="${RegError}"></div></tr></td>
										</tr>
									</table>
